...
{
    public class IdentityValueBinding : DuckValueBindingOption
    {
        static readonly IdentityValueBinding Instance = new IdentityValueBinding();

        public static DuckValueBindingOption TryBind(Type fromType, Type toType)
        {
            return fromType==toType ? Instance : null;
        }

        IdentityValueBinding() {}
