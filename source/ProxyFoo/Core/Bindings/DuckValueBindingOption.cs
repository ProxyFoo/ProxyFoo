...
namespace ProxyFoo.Core.Bindings
{
    public abstract class DuckValueBindingOption
    {
        ...
        public static DuckValueBindingOption GetForParam(ParameterInfo adaptee, ParameterInfo candidate)
        {
            return Get(adaptee.ParameterType, candidate.ParameterType);
        }

        public static DuckValueBindingOption GetForRetVal(Type adaptee, Type candidate)
        {
            return Get(candidate, adaptee);
        }
