...
{
    public class ImplicitReferenceValueBinding : DuckValueBindingOption
    {
        static readonly ImplicitReferenceValueBinding Instance = new ImplicitReferenceValueBinding();
