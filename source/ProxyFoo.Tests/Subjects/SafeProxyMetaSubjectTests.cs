...
{
    public class SafeProxyMetaSubjectTests : SubjectTestsBase<SafeProxyMetaSubject>
    {
        protected override IEnumerable<SafeProxyMetaSubject> CreateSamples()
        {
            yield return new SafeProxyMetaSubject();
        }

        [Test]
        public void CanCreateCoder()
        {
            var subject = new SafeProxyMetaSubject();
