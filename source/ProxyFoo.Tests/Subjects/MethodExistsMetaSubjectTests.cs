...
{
    [TestFixture]
    public class MethodExistsMetaSubjectTests : SubjectTestsBase<MethodExistsProxyMetaSubject>
    {
        protected override IEnumerable<MethodExistsProxyMetaSubject> CreateSamples()
        {
            yield return new MethodExistsProxyMetaSubject();
        }
