...
{
    [TestFixture]
    public class RealSubjectMixinTests : MixinTestsBase<RealSubjectMixin>
    {
        [Test]
        public void NullRealSubjectThrowsException()
        {
            Assert.Throws<ArgumentNullException>(() => new RealSubjectMixin(null, null));
        }

        protected override IEnumerable<RealSubjectMixin> CreateSamples()
        {
